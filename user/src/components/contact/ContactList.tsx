...
export default function ContactList() {
  return (
    <div className="text-black w-0 md:min-w-[250px] md:w-[25%] justify-center overflow-y-scroll custom-scroll-contact-card contact-list-bg  " style={{ height: "calc(100vh - 5rem)" }}>
